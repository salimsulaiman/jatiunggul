      ...
      <section className="w-full bg-white mt-4" id="about">
        <div className="max-w-screen-xl mx-auto px-6 md:px-12 lg:px-6 py-10 md:py-20 flex flex-col gap-4 items-center">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <ProductCard
              name={"Set Meja Makan Kayu Jati"}
              category={"Meja dan Kursi"}
              price={1600000}
            />
            <ProductCard
              name={"Sofa Bed Kulit 2 Seat - Hitam dan Putih"}
              category={"Sofa"}
              price={3800000}
            />
            <ProductCard
              name={"Lemari Rak Sepatu Susun 4 Tingkat - Putih"}
              category={"Lemari"}
              price={4000000}
            />
            <ProductCard
              name={"Set Meja dan Kursi Belajar"}
              category={"Meja dan Kursi"}
              price={1700000}
            />
          </div>
