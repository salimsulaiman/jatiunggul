    ...
    <div className="w-full font-urbanist" id="home">
            ...
            <div className="flex h-full items-center w-full flex-col lg:flex-row mt-12 lg:mt-0">
              <div className="w-full lg:w-5/12">
                ...
                <div className="flex w-full">
                  <Link href={"#product"} className="bg-yellow-400 text-slate-700 hover:bg-yellow-500 py-2 px-5 rounded-full font-medium mt-4 block w-fit me-4">Jelajahi</Link>
          ...
          <div className="w-full lg:w-6/12 flex-grow">
            ...
            <div className="w-full grid grid-cols-2 gap-6 md:gap-4 mt-10">
              <div className="w-full flex flex-col">
                ...
                <h4 className="text-slate-700 font-bold mt-2 text-base sm:text-lg">Cepat Dalam Pengiriman</h4>
                <h4 className="text-slate-400 text-sm sm:text-base mt-2 text-justify md:text-start">Pengiriman cepat dan tepat waktu,  Anda dapat menikmati produk pilihan Anda tanpa penundaan.</h4>
              </div>
              <div className="w-full flex flex-col">
                <div className="w-12 h-12 bg-slate-300 rounded-full flex items-center justify-center">
                ...
                <h4 className="text-slate-400 text-sm sm:text-base mt-2 text-justify md:text-start">Produk berkualitas tinggi harga ramah di kantong, Mendapatkan nilai terbaik untuk setiap pembelian.</h4>
              </div>
              <div className="w-full flex flex-col mt-6">
                ...
                <h4 className="text-slate-400 text-sm sm:text-base mt-2 text-justify md:text-start">Bahan baku dan proses pembuatan yang teliti untuk memastikan produk tahan lama, kokoh, dan tampil menawan.</h4>
              </div>
              <div className="w-full flex flex-col mt-6">
                <div className="w-12 h-12 bg-slate-300 rounded-full flex items-center justify-center">
                ...
                <h4 className="text-slate-400 text-sm sm:text-base mt-2 text-justify md:text-start">Memberikan garansi pada setiap produk mebel kami, menjamin kualitas dan kepuasan bagi semua pelanggan.</h4>
              </div>
            </div>
          </div>
      ...
      <section className="w-full bg-white" id="gallery">
        <div className="max-w-screen-lg mx-auto px-6 md:px-12 lg:px-6 py-10 md:py-20">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-center text-slate-700">
            Galeri Kami
          </h2>
          ...
          <div className="grid grid-cols-3 gap-4 md:gap-6 lg:gap-9 mt-12">
            <div className="grid grid-rows-3 gap-4 md:gap-6 lg:gap-9 mt-0 md:mt-6 lg:mt-9">
              <div className="h-[200px] sm:h-[300px] md:h-[350px] lg:h-[500px] bg-slate-200 overflow-hidden rounded-tl-[66px] group">
            ...
            <div className="grid grid-rows-3 gap-4 md:gap-6 lg:gap-9 mt-0 md:mt-6 lg:mt-9">
              <div className="h-[200px] sm:h-[300px] md:h-[350px] lg:h-[500px] bg-slate-200 overflow-hidden group rounded-br-[66px]">
